class TooFewArgumentsError(Exception):
    def __init__(self):
        self.msg = "Error! You didn't pass enough arguments. You'll need a set code. Try `python3 app.py ONS`"
...
class TooManyArgumentsError(Exception):
    def __init__(self, args):
        self.msg = "Error! Agh! You passed too many arguments. Only pass one after app.py ie. `python3 app.py ONS"
        self.args = args
